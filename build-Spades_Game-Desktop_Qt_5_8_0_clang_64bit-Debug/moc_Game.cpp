...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::sendHand)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::printText)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::getUserBid)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (Game::*_t)(string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::putOpp1Card)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (Game::*_t)(string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::putOpp2Card)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (Game::*_t)(string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::putTMCard)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (Game::*_t)(string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::putPlayerCard)) {
                *result = 6;
                return;
            }
        }
